...
echo '**** Stats solos ****<br/>';
echo "=====================<br/>";
echo "Le personnage 1 a ",$perso1->getForce(), " de force. Et le personage 2, ", $perso2->getForce(), " points de force.<br/>";
echo "Le personnage 1 a ",$perso1->getExperience(), " d'XP. Et le personage 2, ", $perso2->getExperience(), " points d'XP.<br/>";
echo "Le personnage 1 a prit ".$perso1->getDegats(), " point de degats contre ",$perso2->getDegats(), " pour le second.<br/>";
echo "<br/>=====================<br/>";
Personnage::parler();
echo "<br/>=====================<br/>";
